...
class StaffsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'img_path' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created_date' => '2018-04-01 11:39:15',
            'updated_date' => '2018-04-01 11:39:15',
            'is_deleted' => 1
        ],
    ];
}
